'--------------------------------------------------------------------
' Richiede i dati in automatico ogni 5 secondi e all'uscita da testser
' registra in un file excel in C:\DOCS con nome GGMMAA-HHMMSS.XLS
'
'--------------------------------------------------------------------
...
Public Sub InitTask()
	 ...
	 TimerTask.Interval=5000
		...
		ExcelFileName=FormatDateTime(Date,vbLongDate)& "-" & FormatDateTime(Time,vbLongTime) & ".XLS"
